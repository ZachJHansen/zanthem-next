...
%%%% Conjecture %%%%
tff(statement, conjecture, ![V1g: object, V2g: object]: (color(V1g, V2g) <=> ?[Xg: object, Zg: object]: (V1g = Xg & V2g = Zg & (?[Zg: object]: (Zg = Xg & vertex(Zg)) & ?[Z1g: object]: (Z1g = Zg & color(Z1g))) & ~~color(V1g, V2g)))).
