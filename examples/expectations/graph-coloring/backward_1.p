...
tff(predicate_0, type, color: (object * object) > $o).
tff(predicate_1, type, color: (object) > $o).
tff(predicate_2, type, vertex: (object) > $o).
tff(predicate_3, type, edge: (object * object) > $o).
...
tff(statement, axiom, ![Xg: object, Z1g: object, Z2g: object]: (color(Xg, Z1g) & color(Xg, Z2g) => Z1g = Z2g)).

tff(statement, axiom, ~(?[Xg: object, Yg: object, Zg: object]: (edge(Xg, Yg) & color(Xg, Zg) & color(Yg, Zg)))).

%%%% Conjecture %%%%
tff(statement, conjecture, ![Xg: object, Z1g: object, Z2g: object]: (?[Zg: object, Z2g: object]: (Zg = Xg & Z2g = Z1g & color(Zg, Z2g)) & ?[Zg: object, Z1g: object]: (Zg = Xg & Z1g = Z2g & color(Zg, Z1g)) & ?[Zg: object, Z3g: object]: (Zg = Z1g & Z3g = Z2g & Zg != Z3g) => $false)).
