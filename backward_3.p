...
tff(statement, axiom, ![V1g: object]: (prime(V1g) <=> ?[Ki: $int]: ($lesseq(2, Ki) & $lesseq(Ki, n) & V1g = f__integer__(Ki) & ~composite_1(V1g)))).

tff(statement, axiom, ![Mi: $int, Ni: $int]: ($greatereq(Mi, 1) & $greatereq(Ni, 1) => $greatereq($product(Mi, Ni), Mi))).

%%%% Conjecture %%%%
tff(statement, conjecture, ![V1g: object]: (prime(V1g) => ?[Ki: $int]: ($lesseq(2, Ki) & $lesseq(Ki, n) & V1g = f__integer__(Ki) & ~composite_2(V1g)))).
