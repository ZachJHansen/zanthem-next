...
%%%% Axioms %%%%
tff(statement, axiom, ![V1: object]: (q(V1) <=> (?[X: object]: (V1 = X & ?[Z: object]: (Z = X & t(Z))) | ?[X: object]: (V1 = X & ?[Z: object]: (Z = X & r1_1(Z)))))).

%%%% Conjecture %%%%
tff(statement, conjecture, ![V1: object]: (q(V1) <=> ?[X: object]: (V1 = X & (?[Z: object]: (Z = X & t(Z)) & ?[Z: object]: (Z = X & r2_2(Z)))))).
