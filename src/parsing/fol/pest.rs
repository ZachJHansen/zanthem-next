use crate::{
    parsing::PestParser,
    syntax_tree::fol::{
        AnnotatedFormula, Atom, AtomicFormula, BasicIntegerTerm, BinaryConnective, BinaryOperator,
        Comparison, Direction, Formula, FormulaName, GeneralTerm, Guard, IntegerTerm, Placeholder,
        Predicate, Quantification, Quantifier, Relation, Role, Sort, Spec, Specification, Theory,
        UnaryConnective, UnaryOperator, UserGuide, Variable,
    },
};
...
mod tests {
    ...
    use {
        super::{
            ...
            BinaryConnectiveParser, BinaryOperatorParser, ComparisonParser, FormulaParser,
            GeneralTermParser, GuardParser, IntegerTermParser, PlaceholderParser, PredicateParser,
